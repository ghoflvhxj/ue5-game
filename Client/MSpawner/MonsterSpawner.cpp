...
#include "Client/MGameState/MGameStateInGame.h"
...
void AMonsterSpawner::BeginPlay()
{
	...
	GameState->RoundStartedDelegate.AddWeakLambda(this, [this, GameState](FRoundInfo RoundInfo) {
		for (int i = 0; i < RoundInfo.SpawnNum; ++i)
		{
			...
			SpawnedMonster->AddVitalityChangedDelegate(this, [this, SpawnedMonster, RoundInfo, GameState](uint8 OldStateValue, uint8 NewStateValue) {
				if (NewStateValue == static_cast<uint8>(ECharacterVitalityState::Die))
				{
